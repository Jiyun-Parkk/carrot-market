...
const Community: NextPage = () => {
  return (
    <div className='uspace-y-8 py-16 px-4'>
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <div key={i} className='mb-6 flex flex-col items-start'>
      ...
      <button className='fixed bottom-10 right-5 cursor-pointer  rounded-full bg-orange-400 p-4 text-white shadow-xl transition-colors hover:bg-orange-500'>
        <svg
          className='h-6 w-6'
          fill='none'
          stroke='currentColor'
